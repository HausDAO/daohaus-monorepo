...
import { ListDaosQuery } from '@daohaus/dao-data';
import { Container, Grid } from '@material-ui/core';
import { Button, Card, Icon, Identicon, Link, Loader, Title, Text } from '@gnosis.pm/safe-react-components';
  ...
  return (
      <StyledMainContainer>
        <Grid container direction='row' justifyContent='space-between'>
          ...
          <Grid item>
            <Button iconType='add' size='md' textSize='lg' iconSize='sm' color='primary' onClick={() => newBaalEvent()}>
              New DAO
            </Button>
          </Grid>
        </Grid>
                    ...
                    <Link href='#'>
                      <StyledDaoCard>
                        <Grid container direction='column' spacing={2}>
                          ...
                          <Grid item>
                            <Text strong size='xl'>{dao.name}</Text>
                          </Grid>
                          <Grid item>
                          ...
                          <Grid item>
                            <Text size='md'>Created: {new Date(Number(dao.createdAt) * 1000).toLocaleDateString()}</Text>
                          </Grid>
                        </Grid>
                      </StyledDaoCard>
                    </Link>
